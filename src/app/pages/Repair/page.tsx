  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white p-4 mt-6 rounded shadow">
        ...
        {/* Search */}
        <div className="flex items-center gap-2 border w-full sm:w-80 mt-6 border-gray-300 rounded px-2 py-1">
        ...
        <div className="border rounded mt-4 border-gray-300">
          {/* Header */}
          <div className="grid p-4 bg-gray-100 grid-cols-1 sm:grid-cols-6 gap-4 font-semibold text-sm">
            <div>Name</div>
            <div>Phone</div>
            <div>CNIC</div>
            <div>Email</div>
          ...
          {filteredData.length === 0 ? (
            ...
            filteredData.map((e, i) => (
              <div key={i}>
                <div className="grid p-4 hover:bg-gray-50 grid-cols-1 sm:grid-cols-6 gap-4 text-sm">
                  <div>{e.Name}</div>
                  <div>{e.Phone}</div>
                  <div>{e.CNIC}</div>
                  <div>{e.Email}</div>
