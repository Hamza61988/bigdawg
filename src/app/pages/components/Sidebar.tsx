...
export default function Sidebar({ mobile = false }: { mobile?: boolean }) {
  ...
  const buttons = [
    ...
    { label: 'Inventory', icon:<FiBox />, href: '/pages/inventory' },
    ...
    { label: 'Repair', icon: <GoTools />, href: '/pages/Repair' },
    { label: 'Reports', icon: <BsGraphUp />, href: '/pages/Reports' },
    { label: 'Help and Support', icon: <MdOutlineSupportAgent />, href: '/pages/Support' },
  ];
